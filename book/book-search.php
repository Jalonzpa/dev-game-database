...
switch ($play_age) {
   ...
   $query = "SELECT color, number, game_name FROM `dev-main` WHERE player_number = '{$player}' ORDER BY color, number";
   ...
   while ($j < $rows)
       {  
          ...
          for ($i = 0 ; $i < 3 ; $i++){
	          ...
	          echo '<div class="row"><div class="col-6"><img src="images/'.$color.$number.'.png"></div>';
